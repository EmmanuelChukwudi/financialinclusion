...
st.markdown("<h3 style = 'margin: -25px; color: #FFC436; text-align: center;font-family: Arial, Helvetica, sans-serif; '>BY CHUKWUDI ONOVO</h3>", unsafe_allow_html= True)
st.image('image1.jpeg', width = 400)
...
if st.button('Press To Predict'):
    ...
    st.image('image2.jpeg', width = 100)
